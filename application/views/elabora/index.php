...
<div id="content-outer">
    ...
    <div id="content">
        <!--  start top-search -->
        <div id="top-search">
            <div id="titulo-ind" >Disertacion Elaborada Por Estudiante   <a href="<?php echo site_url('elabora/add')?>"> <img src="<?php echo base_url();?>assets/images/pantalla_main/btn-add.png"></a>
                <table id= "tabla-busqueda" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <form action= <?php echo site_url("/elabora/buscarElabora") ?>  method ="post">
                        <td>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
    ...
    <tr>
		...
		<td>
            ...
            <a href="<?php echo site_url('elabora/remove/'.$e['est_codigo'].'/'.$e['dis_codigo']); ?>">Eliminar</a>
        </td>
    </tr>
	<?php } ?>
</table>
