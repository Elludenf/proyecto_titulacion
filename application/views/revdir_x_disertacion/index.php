...
<div id="content-outer">
    ...
    <div id="content">
        <!--  start top-search -->
        <div id="top-search">
            <div id="titulo-ind" >Directores y Revisores por Disertación   <a href="<?php echo site_url('revdir_x_disertacion/add')?>"> <img src="<?php echo base_url();?>assets/images/pantalla_main/btn-add.png"></a>
                <table id= "tabla-busqueda" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <form action= <?php echo site_url("/revdir_x_disertacion/buscarRevDirXDis") ?>  method ="post">
                        <td>
