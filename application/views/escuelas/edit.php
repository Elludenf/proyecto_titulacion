...
<?php echo form_open('escuela/edit/'.$escuela['esc_codigo']); ?>
	...
	<div id="custom-lbl" >Esc Descripcion : <input type="text"  class="edit-inp" name="esc_descripcion" value="<?php echo ($this->input->post('esc_descripcion') ? $this->input->post('esc_descripcion') : $escuela['esc_descripcion']); ?>" /></div>
