...
<div id="content-outer">
    ...
    <div id="content">
        <!--  start top-search -->
        <div id="top-search">
            <div id="titulo-ind" >Usuarios   <a href="<?php echo site_url('pg_authid/add')?>"> <img src="<?php echo base_url();?>assets/images/pantalla_main/btn-add.png"></a>
    ...
    <div id="select-report">
        ...
        <div class="btn-reports">
            <a href='<?php echo site_url('pg_authid/add')?>' class="btn-reports-default">NUEVO</a>
        </div>
    </div>
    ...
    <tr>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Rolname</th>
    ...
    <tr>
		...
		<td>
            <a href="<?php echo site_url('pg_authid/edit/'.$p['rolname']); ?>">Editar</a> |
            <a href="<?php echo site_url('pg_authid/remove/'.$p['rolname']); ?>">Eliminar</a>
        </td>
    </tr>
	<?php } ?>
</table>
