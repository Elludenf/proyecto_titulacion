...
<div id="content-outer">
    ...
    <tr>
        ...
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Nombre1</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Nombre2</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Apellido1</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Apellido2</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Tipoid</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Id</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Direccion</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Telefono</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Celular</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Mail</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Mailpuce</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Fechanac</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Sexo</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Foto</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Prof Oficina</th>
