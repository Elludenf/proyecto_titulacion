...
<?php echo form_open('materia/add'); ?>
	...
	<div id="custom-lbl">Mat Nombre : <input type="text" class="edit-inp" name="mat_nombre" value="<?php echo $this->input->post('mat_nombre'); ?>" /></div>
	<div id="custom-lbl">Mat Nivel : <input type="text" class="edit-inp" name="mat_nivel" value="<?php echo $this->input->post('mat_nivel'); ?>" /></div>
