...
<div id="content-outer">
    ...
    <div id="content">
        <!--  start top-search -->
        <div id="top-search">
            <div id="titulo-ind" >Materias   <a href="<?php echo site_url('materia/add')?>"> <img src="<?php echo base_url();?>assets/images/pantalla_main/btn-add.png"></a>
                <table id= "tabla-busqueda" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <form action= <?php echo site_url("/materia/buscarMateria") ?>  method ="post">
                        <td>
    ...
    <tr>
        ...
        <th class="table-header-repeat line-left minwidth-1"><a href="">Nombre</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Nivel</th>
    ...
    <tr>
		...
		<td>
            <a href="<?php echo site_url('materia/edit/'.$m['mat_codigo']); ?>">Editar</a> |
            <a href="<?php echo site_url('materia/remove/'.$m['mat_codigo']); ?>">Eliminar</a>
        </td>
    </tr>
	<?php } ?>
</table>
