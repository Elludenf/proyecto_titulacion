...
<div id="content-outer">
    ...
    <tr>
        ...
        <th class="table-header-repeat line-left minwidth-1"><a href="">Pac Descripcion</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Pac Fechainicio</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Pac Fechafinal</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Pac Perido</th>
    ...
    <tr>
		...
		<td>
            <a href="<?php echo site_url('periodos_academicos/edit/'.$p['pac_codigo']); ?>">Edit</a> |
            <a href="<?php echo site_url('periodos_academicos/remove/'.$p['pac_codigo']); ?>">Delete</a>
        </td>
    </tr>
	<?php } ?>
</table>
