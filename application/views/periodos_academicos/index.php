...
<div id="content-outer">
    ...
    <div id="content">
        <!--  start top-search -->
        <div id="top-search">
            <div id="titulo-ind" >Periodos Academicos   <a href="<?php echo site_url('periodos_academicos/add')?>"> <img src="<?php echo base_url();?>assets/images/pantalla_main/btn-add.png"></a>
                <table id= "tabla-busqueda" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <form action= <?php echo site_url("/periodos_academicos/buscarPeriodoAcademico") ?>  method ="post">
                        <td>
    ...
    <tr>
        ...
        <th class="table-header-repeat line-left minwidth-1"><a href="">Fecha Final</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Periodo </th>
    ...
    <tr>
		...
		<td>
            <a href="<?php echo site_url('periodos_academicos/edit/'.$p['pac_codigo']); ?>">Editar</a> |
            <a href="<?php echo site_url('periodos_academicos/remove/'.$p['pac_codigo']); ?>">Eliminar</a>
        </td>
    </tr>
	<?php } ?>
</table>
