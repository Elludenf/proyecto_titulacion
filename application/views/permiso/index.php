...
<div id="content-outer">
    ...
    <div id="content">
        <!--  start top-search -->
        <div id="top-search">
            <div id="titulo-ind" >Permisos<a href="<?php echo site_url('permiso/add')?>"> <img src="<?php echo base_url();?>assets/images/pantalla_main/btn-add.png"></a>
    ...
    <div id="select-report">
        ...
        <div class="btn-reports">
            <a href='<?php echo site_url('permiso/add')?>' class="btn-reports-default">NUEVO</a>
        </div>
    </div>
    ...
    <tr>
        ...
        <th class="table-header-repeat line-left minwidth-1"><a href="">Creat</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Read</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Update</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Delete</th>
    ...
    <tr>
		...
		<td>
            <a href="<?php echo site_url('permiso/edit/'.$p['perm_codigo']); ?>">Editar</a> |
            <a href="<?php echo site_url('permiso/remove/'.$p['perm_codigo']); ?>">Eliminar</a>
        </td>
    </tr>
	<?php } ?>
</table>
