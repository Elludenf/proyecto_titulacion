...
<div id="content-outer">
    ...
    <tr>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Zpermcodigo</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Zperm Estado</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Zperm Creat</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Zperm Read</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Zperm Update</th>
        <th class="table-header-repeat line-left minwidth-1"><a href="">Zperm Delete</th>
