...
class Materia extends CI_Controller
{
    ...
    function buscarMateria()
    {
        ...
        if (isset($_SERVER['HTTP_REFERER'])) {
            $data['materias'] = $this->Materia_model->getMateriaBusqueda($this->input->post('search'));

            /*Empiezo de paginacion*/
            $total_rows = $this->Materia_model->countParamSearch($this->input->post('search'));

            $this->load->library('pagination');
            //   $config['total_rows'] = $total_rows;
            $config['per_page'] = 5;
            $config['uri_segment'] = 3;
            $config['base_url'] = base_url() . '/materia/buscarMateria';
