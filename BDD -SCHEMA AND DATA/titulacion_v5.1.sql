...
/* Created on:     8/01/2017 8:06:36 p. m.                      */
/*==============================================================*/
...
create table ZROLES (
   ZROLCODIGO           VARCHAR(5)           not null,
   ZROLDESCRIPCION      VARCHAR(50)          not null,
...
create table ZUSUARIOS (
   ZUSRCODIGO           VARCHAR(15)          not null,
   ZROLCODIGO           VARCHAR(5)           not null,
   PER_CODIGO           INT4                 null,
   ZUSRNOMBRE           VARCHAR(50)          not null,
   ZUSRCLAVE            VARCHAR(15)          not null,
...
/* Table: ZUSUARIOSE                                            */
/*==============================================================*/
create table ZUSUARIOSE (
   ZUSRECODIGO          VARCHAR(15)          not null,
   ZROLCODIGO           VARCHAR(5)           not null,
   PER_CODIGO           INT4                 null,
   ZUSRENOMBRE          VARCHAR(50)          not null,
   ZUSRECLAVE           VARCHAR(15)          not null,
   constraint PK_ZUSUARIOSE primary key (ZUSRECODIGO)
);

/*==============================================================*/
/* Index: ZUSUARIOSE_PK                                         */
/*==============================================================*/
create unique index ZUSUARIOSE_PK on ZUSUARIOSE (
ZUSRECODIGO
);
...
/* Index: ZROL_USRE_FK                                          */
/*==============================================================*/
create  index ZROL_USRE_FK on ZUSUARIOSE (
ZROLCODIGO
);
...
alter table ZUSUARIOSE
   add constraint FK_ZUSUARIO_USUEXPERS_ESTUDIAN foreign key (PER_CODIGO)
      references ESTUDIANTE (PER_CODIGO)
      on delete restrict on update restrict;

alter table ZUSUARIOSE
   add constraint FK_ZUSUARIO_ZROL_USRE_ZROLES foreign key (ZROLCODIGO)
      references ZROLES (ZROLCODIGO)
      on delete restrict on update restrict;
