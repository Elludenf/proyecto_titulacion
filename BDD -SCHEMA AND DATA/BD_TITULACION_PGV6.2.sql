...
/* Created on:     12/01/2017 9:29:49 a. m.                     */
/*==============================================================*/
...
alter table estudiante
  add constraint "UNIQUE_ESTUDIANTE_ID" unique(per_id );
  
alter table estudiante
  add constraint "UNIQUE_ESTUDIANTE_MAIL1" unique(per_mail );
  
alter table estudiante
  add constraint "UNIQUE_ESTUDIANTE_mail2" unique(per_mailpuce );
...
alter table profesor
  add constraint "UNIQUE_PROFESOR_ID" unique(per_id );
  
alter table profesor
  add constraint "UNIQUE_PROFESOR_EMAIL1" unique(per_mail );
  
alter table profesor
  add constraint "UNIQUE_PROFESOR_MAIL2" unique(per_mailpuce );
